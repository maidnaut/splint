	...
	<div class="reply" id="reply">
		<?php
			...
			if ($url[2] == "thread") {
				...
				echo "<div style='text-align: center; margin-bottom: 16px;'>Posting new <b>thread</b></div>";
			}
		?>
		<form action="<?=$cfg['sitedir']?>/post.php" method="post" enctype="multipart/form-data">
			<table class="tablebg" cellspacing="1" style="display: block; margin-left: 40px; margin-right: auto;">
				<tr> 
